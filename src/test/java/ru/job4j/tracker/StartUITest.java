...
public class StartUITest {
 ...
 /*   @Test
    ...
    public void whenNotFindById() {
        Output out = new StubOutput();
        Tracker tracker = new Tracker();
        Input in = new StubInput(List.of("0", "111", "1"));
        List<UserAction> actions = List.of(
                new FindItemByIdAction(out),
                new ExitAction()
        );
    ...
    public void whenFindByName() {
        ...
        Item item1 = tracker.add(new Item("new item"));
        Item item2 = tracker.add(new Item("new item"));
        Input in = new StubInput(List.of("0", "new item", "1"));
        List<UserAction> actions = List.of(
                new FindItemsByNameAction(out),
                new ExitAction()
        );
    ...
    public void whenNotFindByName() {
        Output out = new StubOutput();
        Tracker tracker = new Tracker();
        Input in = new StubInput(List.of("0", "item", "1"));
        List<UserAction> actions = List.of(
                new FindItemsByNameAction(out),
                new ExitAction()
        );
    ...
    public void whenInvalidExit() {
        Output out = new StubOutput();
        Input in = new StubInput(List.of("32", "0"));
        Tracker tracker = new Tracker();
        List<UserAction> actions = List.of(
                new ExitAction()
        );
