...
public class BankServiceTest {
    ...
    public void whenEnterInvalidRequisite() {
        ...
        bank.addUser(user);
        bank.addAccount(user.getPassport(), new Account("5546", 150D));
        assertNull(bank.findByRequisite("3434", "556").orElse(null));
    }
    ...
    public void whenTransferMoneyBetweenUsers() {
        ...
        assertThat(bank.findByRequisite(user.getPassport(), "1212").get().getBalance(), is(150D));
        assertThat(bank.findByRequisite(user2.getPassport(), "1313").get().getBalance(), is(150D));
    }
    ...
    public void whenAmountMoreBalance() {
        ...
        assertThat(bank.findByRequisite(user.getPassport(), "1212").get().getBalance(), is(200D));
        assertThat(bank.findByRequisite(user2.getPassport(), "1313").get().getBalance(), is(100D));
    }
}